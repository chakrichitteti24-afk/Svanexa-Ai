...
export const BottomNav = memo(function BottomNav() {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-5 items-center justify-items-center h-full w-full max-w-lg mx-auto px-1">
        {mobileNavItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'flex flex-col items-center justify-center w-full h-full min-h-[44px] gap-1 px-1 py-1 transition-all duration-200 select-none',
